...
<nav>
  ...
  <div class="article">
    ...
    <ul>
      <li>
        <a href="#original-mrm-problem">
          Original MRM Problem
        </a>
        <ul>
          <li>
            <a href="#other-kinds-of-trees">
              Other Kinds of Trees
            </a>
          </li>
          <li>
            <a href="#tree-data-structure">
              Tree Data Structure
            </a>
          </li>
        </ul>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            <a href="#canvas-design">
              Canvas Design
            </a>
          </li>
          <li>
            <a href="#drawing-the-axes">
              Drawing the Axes
            </a>
          </li>
          <li>
            <a href="#drawing-the-tree">
              Drawing the Tree
            </a>
            <ul>
              <li>
                <a href="#drawing-a-node">
                  Drawing a Node
                </a>
              </li>
              <li>
                <a href="#node-circle-and-content">
                  Node Circle and Content
                </a>
              </li>
              <li>
                <a href="#line-with-labels-from-node-to-node">
          ...
          <li>
            <a href="#enhancing-rendering-sizes">
      ...
      <li>
        <a href="#more-recursion">
          More Recursion
        </a>
        <ul>
          <li>
            <a href="#caveats-on-recursion">
